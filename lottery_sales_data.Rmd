...
print("---5---")
t1 <- Sys.time()
ev_split(jackpot = 850e6, tickets = 1, max_winners = NA, prob_win = (1/302575350), method = "inverse", split = TRUE)
ev_split(jackpot = 850e6, tickets = 1, max_winners = NA, prob_win = (1/302575350), method = "inverse", split = TRUE)
ev_split(jackpot = 850e6, tickets = 1, max_winners = NA, prob_win = (1/302575350), method = "inverse", split = TRUE)
ev_split(jackpot = 850e6, tickets = 1, max_winners = NA, prob_win = (1/302575350), method = "inverse", split = TRUE)
ev_split(jackpot = 850e6, tickets = 1, max_winners = 0, prob_win = (1/302575350), method = "inverse", split = TRUE)
